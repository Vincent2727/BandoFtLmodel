...
class BandoFtl:
    ...
    def plot_figure(self, position_history, velocity_history, time, vel_std):
        ...
        print(f"Saving Figures with the extension: .._posOffset{self.differnce_vel_var}_{distraction}.png")
        # Plot positions
        ...
        # plt.autoscale()
        plt.tight_layout()
        name = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/pos_posOffset{self.initial_offset}_{distraction}.png'
        plt.savefig(name)
        ...
        plt.legend()
        plt.tight_layout()
        name = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/vel_posOffset{self.initial_offset}_{distraction}.png'
        plt.savefig(name)
        ...
        plt.legend()
        plt.tight_layout()
        name = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/pos_rel_posOffset{self.initial_offset}_{distraction}.png'
        plt.savefig(name)
        ...
        plt.legend()
        plt.tight_layout()
        name = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/vel_rel_posOffset{self.initial_offset}_{distraction}.png'
        plt.savefig(name)
        ...
        csv_filename = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/statistics_{distraction}.csv'
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig(f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/statistics_{distraction}.png')
        ...
        if len(self.wave_started) >= self.num_vehicles:
            ...
            #plt.legend()
            plt.tight_layout()
            name = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/Wave_Started_rel_vel_posOffset{self.initial_offset}_{distraction}.png'
            plt.savefig(name)
...
if plot:
    if manager.pertubance:
        distractionf = f'Distraction{values[-1]}'
    else:
        distractionf = f'NoDistraction{values[-1]}'
    ...
    # plt.legend()
    plt.tight_layout()
    namef = f'/Users/vincentdegaetano/Documents/VsCodeProjects/Traffic_Images/Model_1_Images/WaveStartedvsPerturbationOffset{values[-1]}_{distractionf}.png'
    plt.savefig(namef)
